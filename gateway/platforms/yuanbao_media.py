...
def _cos_sign(
    ...
    sha1_of_http = hashlib.sha1(http_string.encode("utf-8")).hexdigest()  # nosec B324 - SHA1 exigido pelo esquema de assinatura da Tencent (StringToSign); o algoritmo e ditado pela API remota
    string_to_sign = "\n".join([
        "sha1",
        q_sign_time,
        sha1_of_http,
