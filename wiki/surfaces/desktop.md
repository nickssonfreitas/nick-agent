...
type: Surface
title: Desktop
description: The Electron chat app and the transport it shares with the other surfaces.
resource: apps/desktop
tags: [surface, desktop, electron]
status: stable
sources:
  - id: repo
...
[TUI](tui.md) · [Dashboard and web](dashboard-web.md) · [Architecture](../concepts/architecture.md) · [`apps/desktop/AGENTS.md`](../../apps/desktop/AGENTS.md) · [Index](../index.md)
