...
type: Surface
title: Gateway
description: The messaging runtime and every platform adapter.
resource: gateway
tags: [surface, gateway, messaging]
status: stable
sources:
  - id: repo
...
conversation's role alternation stays intact. See [Scheduling](../extensions/scheduling.md).
...
- **The gateway reads config differently from the CLI.** `gateway/run.py` +
  ...
  [Config and profiles § The three loaders](../state/config-and-profiles.md#the-three-config-loaders).
...
[Architecture](../concepts/architecture.md) · [CLI](cli.md) · [Agent core](../core/agent-core.md) · [Session lifecycle](../state/session-lifecycle.md) · [Profile-based routing](../state/profile-routing.md) · [Scheduling](../extensions/scheduling.md) · [Plugins](../extensions/plugins.md) · [Index](../index.md)
