...
type: Surface
title: TUI
description: The Ink terminal UI and its Python JSON-RPC backend.
resource: ui-tui
tags: [surface, tui, typescript]
status: stable
sources:
  - id: repo
...
- **Tests about `.ts`/`.tsx`, `package.json` or lockfiles belong in vitest**, never
  ...
  PR. See [Testing and CI](../operations/testing-and-ci.md).
...
[Architecture](../concepts/architecture.md) · [Desktop](desktop.md) · [Dashboard and web](dashboard-web.md) · [CLI](cli.md) · [Billing lifecycle](billing-lifecycle.md) · [Index](../index.md)
