---
type: Subsystem
title: Billing lifecycle in the client
description: Every billing state shape the gateway serves mapped to what the TUI renders, plus every typed refusal code and its recovery action.
resource: ui-tui/src/components/billingOverlay.tsx
tags: [surfaces, tui, billing]
status: stable
sources:
  - id: repo
  ...
  - id: origin
    resource: docs/billing-lifecycle.md
