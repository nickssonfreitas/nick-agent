---
type: Process
title: Adding a messaging platform
description: "Both routes end to end: the plugin path that touches no core code, and the eleven core files the built-in path still has to change."
resource: gateway/platforms/base.py
tags: [surfaces, gateway, platforms, authoring]
status: stable
sources:
  - id: repo
    resource: git:4bf64c2b6
    title: hermes-agent @ 4bf64c2b6 (branch dev)
    last_modified: 2026-07-28
  - id: origin
    resource: gateway/platforms/ADDING_A_PLATFORM.md
