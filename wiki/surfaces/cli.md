...
type: Surface
title: CLI
description: The interactive REPL, the hermes subcommand tree, the slash-command registry and skins.
resource: cli.py
tags: [surface, cli, slash-commands]
status: stable
sources:
  - id: repo
...
| `load_cli_config()` | `cli.py:408` | CLI-specific config merge. One of [three loaders](../state/config-and-profiles.md#the-three-config-loaders). |
...
| Add a subcommand from a plugin | `ctx.register_cli_command`, see [Plugins](../extensions/plugins.md) |
...
[Architecture](../concepts/architecture.md) · [Config and profiles](../state/config-and-profiles.md) · [Gateway](gateway.md) · [TUI](tui.md) · [Plugins](../extensions/plugins.md) · [Index](../index.md)
