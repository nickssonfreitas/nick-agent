...
rules apply to [MCP catalog manifests](mcp-and-acp.md#the-catalog).
...
`.devmind/product/quality/security/SEMGREP-TRIAGE_2026_07_24.md` section 8.
...
[Testing and CI](testing-and-ci.md) · [Config and profiles](config-and-profiles.md) · [Plugins](plugins.md) · [Index](index.md)
