---
type: Research
title: Why did the SSL CA bundle break after `hermes update`?
description: Root-cause analysis of the CA certificate bundle being corrupted by an update, and what stopped it recurring.
resource: hermes_cli/
tags: [research, rca, tls, update]
status: stable
question: What corrupted the SSL CA certificate bundle after running `hermes update`?
conclusion: Recorded in the analysis below.
sources:
  - id: repo
  ...
  - id: origin
    resource: docs/rca-ssl-cacert-post-git-pull.md
...
---
# 0002. RCA: SSL CA cert bundle corruption after `hermes update`
