---
type: Research
title: Which Semgrep findings are real?
description: "Triage of the Semgrep run: which rules fire truthfully here, which are noise for this codebase, and why each suppression is defensible."
resource: .security/scan.sh
tags: [research, security, semgrep, static-analysis]
status: stable
question: Which Semgrep findings are true positives in this codebase?
conclusion: Recorded per rule below; the noisy rules are named in sections 4 and 5.
sources:
  - id: repo
  ...
  - id: origin
    resource: .devmind/product/quality/security/SEMGREP-TRIAGE_2026_07_24.md
...
---
# 0005. Semgrep Triage & Action Plan — Hermes Agent
