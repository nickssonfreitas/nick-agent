...
[import chain](architecture.md#the-import-chain).
...
is a [change-detector test](testing-and-ci.md#change-detector-tests).
...
Settle the [Footprint Ladder](architecture.md#the-footprint-ladder-read-before-adding-anything)
...
| Add a local or custom tool | a plugin, see [Plugins](plugins.md) |
...
[Architecture](architecture.md) · [Agent core](agent-core.md) · [Terminal backends](terminal-backends.md) · [Plugins](plugins.md) · [MCP and ACP](mcp-and-acp.md) · [Index](index.md)
