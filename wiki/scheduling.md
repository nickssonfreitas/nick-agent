...
'<name>'`. See [Gateway § Adding a platform](gateway.md#adding-a-platform).
...
contracts: [`docs/kanban/`](../docs/kanban), [`docs/chronos-managed-cron-contract.md`](../docs/chronos-managed-cron-contract.md).
...
delegation. See [Agent core § Delegation](agent-core.md#delegation).
...
[Gateway](gateway.md) · [Agent core](agent-core.md) · [Config and profiles](config-and-profiles.md) · [Index](index.md)
