...
| `register_platform` | A messaging platform adapter ([Gateway](gateway.md#adding-a-platform)) |
...
stored for forward compatibility but warned, so typos surface.
Notes: [`docs/middleware/README.md`](../docs/middleware/README.md), observer schema
version `hermes.observer.v1`.
...
| Add a platform | `ctx.register_platform`, see [Gateway](gateway.md) |
...
[Tools](tools.md) · [Gateway](gateway.md) · [Providers and models](providers-and-models.md) · [Memory and context](memory-and-context.md) · [Index](index.md)
