---
type: Contract
title: Relay-to-connector contract (v1, experimental)
description: "The wire contract between the relay and a connector. Machine-enforced: tests/gateway/relay/test_contract_doc_conformance.py reads this page and asserts the Python matches it."
resource: gateway/relay/
tags: [extensions, relay, gateway, contract]
status: stable
sources:
  - id: repo
  ...
  - id: origin
    resource: docs/relay-connector-contract.md
