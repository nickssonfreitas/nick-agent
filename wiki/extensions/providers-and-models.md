...
description: Inference backends, credential pools and model routing.
resource: providers
tags: [extension, providers, models]
status: stable
sources:
  - id: repo
...
instead ([Testing and CI](../operations/testing-and-ci.md#change-detector-tests)).
...
[Agent core § Provider adapters](../core/agent-core.md#provider-adapters).
...
- **Pin dependencies with upper bounds** if a provider pulls a new package. See
  [Packaging and release](../operations/packaging-and-release.md#dependency-pinning).
...
[Agent core](../core/agent-core.md) · [Plugins](plugins.md) · [Config and profiles](../state/config-and-profiles.md) · [Index](../index.md)
