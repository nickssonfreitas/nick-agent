...
description: The observation points the agent emits, what each event carries, and how an observability plugin subscribes without touching the loop.
resource: plugins/observability/
tags: [extensions, observability, hooks, plugins]
status: stable
sources:
  - id: repo
  ...
  - id: origin
    resource: docs/observability/README.md
