...
type: Subsystem
title: Middleware
description: The hook points a plugin can wrap around a call, the kwargs contract each one receives, and the ordering rules between stacked middleware.
resource: plugins/
tags: [extensions, middleware, plugins]
status: stable
sources:
  - id: repo
  ...
  - id: origin
    resource: docs/middleware/README.md
