---
type: Contract
title: Chronos managed-cron wire contract
description: "The agent-to-NAS wire contract for managed cron: message shapes, ownership of the schedule, and the failure modes each side must tolerate."
resource: plugins/cron_providers/chronos/
tags: [extensions, cron, scheduling, contract]
status: stable
sources:
  - id: repo
  ...
  - id: origin
    resource: docs/chronos-managed-cron-contract.md
