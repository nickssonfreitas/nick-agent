---
type: Subsystem
title: Skills and curator
description: Bundled and agent-created skills, the skills hub, and the curator that keeps them alive.
resource: skills
tags: [extension, skills, curator]
status: stable
sources:
  - id: repo
...
[`AGENTS.md` § Skills](../../AGENTS.md#skills).
...
[Tools](../core/tools.md) · [Memory and context](../state/memory-and-context.md) · [CLI](../surfaces/cli.md) · [Plugins](plugins.md) · [Index](../index.md)
