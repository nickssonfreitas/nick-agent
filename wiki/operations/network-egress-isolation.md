---
type: Process
title: Network egress isolation for Docker deployments
description: Constraining what the agent container can reach on the network, and why the default bridge is not enough.
resource: docker-compose.yml
tags: [operations, security, docker, networking]
status: stable
sources:
  - id: repo
  ...
  - id: origin
    resource: docs/security/network-egress-isolation.md
