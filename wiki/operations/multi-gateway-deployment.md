---
type: Process
title: Running more than one gateway
description: What has to be true to run several gateway instances against one Hermes home without them fighting over sessions.
resource: gateway/
tags: [operations, deployment, gateway]
status: stable
sources:
  - id: repo
  ...
  - id: origin
    resource: docs/kanban/multi-gateway.md
