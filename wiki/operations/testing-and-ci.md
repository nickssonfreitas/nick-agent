...
description: How the suite runs, where a test belongs, and what the change classifier does.
resource: scripts/run_tests.sh
tags: [operations, testing, ci]
status: stable
sources:
  - id: repo
...
[Architecture](../concepts/architecture.md) · [Packaging and release](packaging-and-release.md) · [Config and profiles](../state/config-and-profiles.md) · [Index](../index.md)
