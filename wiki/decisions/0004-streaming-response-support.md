---
type: Decision
title: Support streaming LLM responses
description: The design for streaming model output through the agent loop and out to each surface, including what it costs the prompt-cache invariant.
...
sources:
  ...
  - id: origin
    resource: .plans/streaming-support.md
