---
type: Decision
title: Keep Telegram streamed replies going past the first overflow chunk
description: The fix plan for streamed Telegram replies terminating after the first overflow chunk, and the approach chosen over the alternatives.
resource: plugins/platforms/telegram/adapter.py
tags: [decisions, gateway, telegram, streaming]
status: stable
...
sources:
  ...
  - id: origin
    resource: docs/plans/2026-06-09-003-fix-telegram-stream-overflow-continuations-plan.md
...
---
# 0002. fix: Prevent Telegram streamed replies from ending after first overflow chunk
