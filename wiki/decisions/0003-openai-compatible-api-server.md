---
type: Decision
title: Expose an OpenAI-compatible API server
description: The design for serving the agent behind an OpenAI-compatible HTTP surface, and what that commits the project to.
...
sources:
  ...
  - id: origin
    resource: .plans/openai-api-server.md
