---
type: Decision
title: Build profile creation in the dashboard, not the CLI
description: Why the profile-creation experience belongs to the dashboard and the prompt_toolkit wizard from PR #31781 was turned down.
resource: web/
...
sources:
  ...
  - id: origin
    resource: docs/design/profile-builder.md
