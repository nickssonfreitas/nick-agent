...
- Manifests pin transport details, following the same supply-chain rules as
  ...
  [Packaging and release § Dependency pinning](packaging-and-release.md#dependency-pinning).
...
[invisibility checklist](tools.md#why-a-tool-is-invisible) applies to them too. Two
...
[Tools](tools.md) · [Plugins](plugins.md) · [Desktop](desktop.md) · [Architecture](architecture.md) · [Index](index.md)
