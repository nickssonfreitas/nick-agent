...
def handle_function_call(
    ...
    try:
        ...
        try:
            ...
            # prefix. Sits after the if/else so it also covers the
            # skip_tool_execution_middleware branch upstream added; idempotent
            # for both normal paths, where a string stays a string.
