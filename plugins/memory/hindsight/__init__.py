...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def post_setup(self, hermes_home: str, config: dict) -> None:
        ...
        if env_writes:
            ...
            env_path.write_text("\n".join(new_lines) + "\n")
            # Este arquivo guarda chave de API. `write_text` preserva o modo de
            # um arquivo que ja existe, mas ao CRIAR usa 0o666 & ~umask — num
            # umask 002, comum em desktop Debian/Ubuntu, o .env nasce 0o664:
            # legivel por todos e gravavel pelo grupo. Hoje ~/.hermes e 0o700 e
            # barra o acesso, entao isto e defesa em profundidade, e alinha com
            # o mode=0o600 que este mesmo arquivo ja usa em atomic_json_write
